...
DeafaultChatDetailsMeta.args = {
  items: [
    {
      header: 'About',
      text: 'Lorem ipsum dolor sit amet, consectetur amet amet, adipiscing elit. Aliquet suscipit nibh aliquet.'
    },
    {
      header: 'E-mail',
  ...
  messages: [
    ...
    },
    {
      ...
      file: {
        ...
        name: 'Annex 2-Disposal Instruction for Handling Foreign Inward Remittances (1).docx.pdf',
        size: 68417
      },
      isReply: false,
      metadata: {
