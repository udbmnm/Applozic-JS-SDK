...
const RecentChatItem = forwardRef<any, IRecentChatItem>(
  ({ recentChat, controls, onClearChat, onClick }, ref) => {
    // useGetMessages(recentChat.chatType, recentChat.contactId);
    ...
    if (recentChat.contactId === '60160532') {
      console.log('debug_13', { recentChat, user, group });
    }
    ...
    // console.log("debug_16", { text: JSON.parse(lastMessage?.messageText });
    let messageText = '';
    try {
