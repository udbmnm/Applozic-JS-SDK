...
import useBoundingRect from '../../../hooks/utility/useBoundingRect';
...
const Item = ({
  ...
  const handleKeyDown: KeyboardEventHandler<HTMLDivElement> | undefined =
    event => event.key === 'Tab' && setUserDidTab(true);
